...
export async function GET(context: APIContext) {
    ...
    `, description: SITE_DESCRIPTION, items: germanPosts.map((post) => {
        ...
        `, description: post.data.description, link: `/de/blog/${slug}/`, pubDate: post.data.pubDate, title: post.data.title,
            };
