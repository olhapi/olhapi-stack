...
const DialogHeader = (props: Readonly<React.HTMLAttributes<HTMLDivElement>>) => {
    const { className, ...restProps } = props;
    return <div className={cn('flex flex-col space-y-1.5 text-center sm:text-left', className)} {...restProps} />;
};
DialogHeader.displayName = 'DialogHeader';

const DialogFooter = (props: Readonly<React.HTMLAttributes<HTMLDivElement>>) => {
    const { className, ...restProps } = props;
    return (
